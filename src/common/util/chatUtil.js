 ...
 */
export const getChatRoomName = (chatEntryNames, chatUserIds) => {
    if (chatEntryNames) {
        ...
        try {
            ...
            writeError('getChatRoomName err', JSON.stringify(chatUserIds), error)
        }
 ...
 */
export const getChatUserIds = (chatEntryIds) => {
    if (chatEntryIds) {
