...
import {getConfig, login, changeStatus, setStatusMonitor } from '../../common/ipcCommunication/ipcCommon'
import {getBuddyList, getBaseOrg, getChildOrg, getUserInfos} from '../../common/ipcCommunication/ipcOrganization'
