    ...
    <div className="contents-wrap">
      <div className="page-title-wrap">
        ...
        {isEditGroupTabOpen && (
          <div class="list-edit-action-wrap">
            <div class="btn-ghost-s capsule cancel" onClick={EditGroupTabClose}>
              취소
            </div>
      ...
      <main className="main-wrap">
        <div className="user-list-group my">
          <h6 className="user-list-title" onClick={clickMyProfileTab}>
            나의 프로필<span className="sub2 user-list-num sss"></span>
          </h6>
          <ul
            className={
              isMyProfileTabOpen ? "user-list-wrap" : "user-list-wrap-hide"
            }
          >
            <li className="user-row">
              <span className="check-wrap">
                <input type="checkbox" id="ckeck-edit" />
                <label htmlFor="ckeck-edit" className="btn-ckeck-edit"></label>
              </span>
              <div className="user-profile-state-wrap">
                <div className="user-pic-wrap">
                  ...
                  >
                    ...
                    <UserInfoTooltip
                      closeUserInfoTooltipFunction={CloseUserInfoTooltip}
                    />
                  </ToolTipController>
                </div>
        ...
        <div className="user-list-group favorite">
          <h6 className="user-list-title" onClick={clickFavoriteTab}>
            즐겨찾기<span className="sub2 user-list-num"></span>
          </h6>
          <ul
            className={
              isFavoriteTabOpen ? "user-list-wrap" : "user-list-wrap-hide"
            }
          >
            <li className="user-row">
              <div className="user-profile-state-wrap">
              ...
              <div className="user-info-wrap">
                <div className="user-name">
                  <h6>
                    김철수<span className="user-position">과장</span>
                    <span className="user-department">개발팀</span>
                    <span className="login-device phone"></span>
                  </h6>
                </div>
