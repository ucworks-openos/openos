...
async function parseRuleInfo(ruleXml) {
    try {
        ...
        for (var ruleCode in ruleFuncs) {
            switch (ruleCode) {
                case 'FUNC_ENCRYPT_2': // Message/Chat Encrypt Algorithm
                    ...
                    logger.info('SET FUNC_ENCRYPT_3 : %s', ruleFuncs[ruleCode].func_value1)
                    break;
                ...
                case 'FUNC_ENCRYPT_4': // Password Encrypt Key
                    ...
                    logger.info('SET FUNC_ENCRYPT_4 : %s', ruleFuncs[ruleCode].func_value1)
                    break;

                case 'FUNC_ORG_1': // ROOT ORG CODE
                    global.ORG.org_1_root = ruleFuncs[ruleCode].func_value1;
                    logger.info('SET FUNC_ORG_1 : %s', ruleFuncs[ruleCode].func_value1)
                    break;
                ...
                case 'FUNC_COMP_39':
                    ...
                    // logger.info('=========================  FNC_COMP_39')
                    // // debug
                    // for (let key in dicOption) {
                    //   logger.info('Key:' + key + " val:" + dicOption[key])
                    // }
                ...
                case 'FUNC_FILE_7' :
                    ...
                    logger.info('SET FUNC_FILE_7: %s', global.BigFileLimit)
                    break;  
                ...
                case 'FUNC_ENCRYPT_5' :
                    ...
                    logger.info('SET FUNC_ENCRYPT_5: %s', global.ENCRYPT.fileAlgorithm)
                    break;  
            }
        }; // rule foreach
        ...
        logger.error('RULE PARSE ERR!! %s', err)
        logger.debug('RULE PARSE ERR!!', ruleXml);
